...
class OutboundDeliverer
  ...
  # domain when the header is missing or unparseable. Key files live
  # under MAIL_ON_RAILS_DKIM_DIR (<domain>.pem, generated by the Domains
  # UI); a missing key sends unsigned, loudly - that usually means the
  # domain was never added as a Domain.
  def signed(message)
