...
class DnsblTest < Minitest::Test
  ...
  test "shared is a no-op checker when no zones are configured" do
    assert_empty MailOnRails::Settings[:smtp_rbl_zones]
    assert_nil Dnsbl.shared.listed("203.0.113.9")
  end
end
