  ...
  module SenderAuth
    ...
    class Dkim
      ...
      def validate_signature_tags(tags)
        ...
        # RFC 6376 8.2: l= leaves everything past the hashed prefix
        # unsigned - an attacker appends a phishing MIME part and the
        # signature (and DMARC) still pass. Refuse the construction
        # outright, as Gmail and other large receivers now do.
